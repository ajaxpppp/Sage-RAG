...
public class Flow {
    private static final String API_URL = "https://api.duojie.games/v1/chat/completions";
    private static final String API_KEY = "sk-7AUdD3x9Jk4bTa9tkvyoZH1Qb576zIaSmI8FmA5LauMDiwr5";

    @Test
    public void Testone(){
        // 1. 构建请求体（注意 stream 设为 true）
        JsonObject requestBody = new JsonObject();
        requestBody.addProperty("model", "claude-opus-4-6-kiro");
